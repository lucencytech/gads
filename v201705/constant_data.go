...
func (s *ConstantDataService) GetAgeRangeCriterion() (ageRanges []AgeRangeCriterion, err error) {
	respBody, err := s.Auth.request(
		...
		struct {
			XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/cm/v201705 getAgeRangeCriterion"`
		}{},
	)
	if err != nil {
...
func (s *ConstantDataService) GetCarrierCriterion() (carriers []CarrierCriterion, err error) {
	respBody, err := s.Auth.request(
		...
		"getCarrierCriterion",
		struct {
			XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/cm/v201705 getCarrierCriterion"`
		}{},
	)
	if err != nil {
		return carriers, err
...
func (s *ConstantDataService) GetGenderCriterion() (genders []GenderCriterion, err error) {
	respBody, err := s.Auth.request(
		...
		"getGenderCriterion",
		struct {
			XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/cm/v201705 getGenderCriterion"`
		}{},
	)
	if err != nil {
		return genders, err
...
func (s *ConstantDataService) GetLanguageCriterion() (languages []LanguageCriterion, err error) {
	respBody, err := s.Auth.request(
		...
		struct {
			XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/cm/v201705 getLanguageCriterion"`
		}{},
	)
	if err != nil {
...
func (s *ConstantDataService) GetMobileDeviceCriterion() (mobileDevices []MobileDeviceCriterion, err error) {
	respBody, err := s.Auth.request(
		...
		struct {
			XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/cm/v201705 getMobileDeviceCriterion"`
		}{},
	)
	if err != nil {
...
func (s *ConstantDataService) GetOperatingSystemVersionCriterion() (operatingSystemVersions []OperatingSystemVersionCriterion, err error) {
	respBody, err := s.Auth.request(
		...
		struct {
			XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/cm/v201705 getOperatingSystemVersionCriterion"`
		}{},
	)
	if err != nil {
...
func (s *ConstantDataService) GetProductBiddingCategoryCriterion(selector Selector) (categoryData []ProductBiddingCategoryData, err error) {
	respBody, err := s.Auth.request(
		...
		struct {
			...
			XMLName: xml.Name{
				Space: "https://adwords.google.com/api/adwords/cm/v201705",
...
func (s *ConstantDataService) GetUserInterestCriterion() (userInterests []UserInterestCriterion, err error) {
	respBody, err := s.Auth.request(
		...
		struct {
			XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/cm/v201705 getUserInterestCriterion"`
		}{},
	)
	if err != nil {
...
func (s *ConstantDataService) GetVerticalCriterion() (verticals []VerticalCriterion, err error) {
	respBody, err := s.Auth.request(
		...
		struct {
			XMLName xml.Name `xml:"https://adwords.google.com/api/adwords/cm/v201705 getVerticalCriterion"`
		}{},
	)
	if err != nil {
